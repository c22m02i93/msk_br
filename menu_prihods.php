...
<li class="text_menu"><b>Показывать:</b> </li>
			   ...
			   else echo '<a href="prihods.php">Все </a>';
				?>
               ...
               <a>По благочиниям</a>
			     <ul>  
							...
							<li <? if ($blag == 1) echo 'class="menu_none"';?>>
			   				...
			   				else echo '<a href="prihods.php?blag=1">1 благочиние</a>';
							?>
							</li>  
							...
							<li <? if ($blag == 2) echo 'class="menu_none"';?>>
			   				...
			   				else echo '<a href="prihods.php?blag=2">2 благочиние</a>';
							?>
							</li>  
							<li <? if ($blag == 3) echo 'class="menu_none"';?>>
               				<?
			   				if ($blag == 3) echo '<a>3 благочиние</a>';
			   				else echo '<a href="prihods.php?blag=3">3 благочиние</a>';
							?>
							</li>  
							<li <? if ($blag == 4) echo 'class="menu_none"';?>>
               				<?
			   				if ($blag == 4) echo '<a>4 благочиние</a>';
			   				else echo '<a href="prihods.php?blag=4">4 благочиние</a>';
							?>
							</li>  
							<li <? if ($blag == 5) echo 'class="menu_none"';?>>
               				<?
			   				if ($blag == 5) echo '<a>5 благочиние</a>';
			   				else echo '<a href="prihods.php?blag=5">5 благочиние</a>';
							?>
							</li>  
