...
$news_all_wer = mysql_query("SELECT * FROM host1409556_barysh.anons WHERE data = '$data'");
...
mysql_query("UPDATE host1409556_barysh.anons SET views = '$views' WHERE data = '$data'");
}

?>
<title><? echo $news_wer[tema];?> - Анонсы и объявления</title>
...
#################################### 
if ($auth == 1) echo '<a style="float: right; margin: 10px;" href="edit.php?table=anons&data='.$data.'"><img src="IMG/edit.png" title="Редактировать" /></a> ';
######################################
...
{
echo '<span class="photos"><a href="FOTO/'.$albom_mas[$j].'.jpg" rel="example_group"><img style="border: 1px solid #BEC7BE; margin: 5px" src="FOTO_MINI/'.$albom_mas[$j].'.jpg" /></a></span>';
